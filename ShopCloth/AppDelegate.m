...
#define kReachabilityChangedNotification @"NetReachability"
...
//    self.window.rootViewController = indexViewController;
    self.shopcode = [[[NSDictionary dictionaryWithContentsOfJSONURLString:kUrlOfInitServices] objectForKey:@"data"] objectForKey:@"shop_code"];
    return YES;
}
